...
enum GLFormat : uint32_t {
    ...
    // Other non-square block sizes not currently supported
...
#define KTX_FORMAT(fmt, metalType, vulkanType, directxType, glType, glBase, x, y, blockSize, numChannels, flags) \
    ...
    KTX_FORMAT(BC2, MyMTLPixelFormatBC2_RGBA, VK_FORMAT_BC2_UNORM_BLOCK, DXGI_FORMAT_BC2_UNORM, GL_COMPRESSED_RGBA_S3TC_DXT3_EXT, GL_RGBA, 4, 4, 16, 4, FLAG_ENC_BC)
    KTX_FORMAT(BC2s, MyMTLPixelFormatBC2_RGBA_sRGB, VK_FORMAT_BC2_SRGB_BLOCK, DXGI_FORMAT_BC2_UNORM_SRGB, GL_COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT, GL_SRGB_ALPHA, 4, 4, 16, 4, FLAG_ENC_BC | FLAG_SRGB)
    ...
    KTX_FORMAT(ASTC10x10, MyMTLPixelFormatASTC_10x10_LDR, VK_FORMAT_ASTC_10x10_UNORM_BLOCK, DXGI_FORMAT_ASTC_10X10_UNORM, GL_COMPRESSED_RGBA_ASTC_10x10_KHR, GL_RGBA, 10, 10, 16, 4, FLAG_ENC_ASTC)
    KTX_FORMAT(ASTC10x10s, MyMTLPixelFormatASTC_10x10_sRGB, VK_FORMAT_ASTC_10x10_SRGB_BLOCK, DXGI_FORMAT_ASTC_10X10_UNORM_SRGB, GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR, GL_SRGB_ALPHA, 10, 10, 16, 4, FLAG_ENC_ASTC | FLAG_SRGB)
    KTX_FORMAT(ASTC10x10h, MyMTLPixelFormatASTC_10x10_HDR, VK_FORMAT_ASTC_10x10_SFLOAT_BLOCK_EXT, DXGI_FORMAT_ASTC_10X10_HDR, GL_COMPRESSED_RGBA_ASTC_10x10_KHR, GL_RGBA, 10, 10, 16, 4, FLAG_ENC_ASTC | FLAG_16F) // gl type same as LDR

    KTX_FORMAT(ASTC12x12, MyMTLPixelFormatASTC_12x12_LDR, VK_FORMAT_ASTC_12x12_UNORM_BLOCK, DXGI_FORMAT_ASTC_12X12_UNORM, GL_COMPRESSED_RGBA_ASTC_12x12_KHR, GL_RGBA, 12, 12, 16, 4, FLAG_ENC_ASTC)
    KTX_FORMAT(ASTC12x12s, MyMTLPixelFormatASTC_12x12_sRGB, VK_FORMAT_ASTC_12x12_SRGB_BLOCK, DXGI_FORMAT_ASTC_12X12_UNORM_SRGB, GL_COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR, GL_SRGB_ALPHA, 12, 12, 16, 4, FLAG_ENC_ASTC | FLAG_SRGB)
    KTX_FORMAT(ASTC12x12h, MyMTLPixelFormatASTC_12x12_HDR, VK_FORMAT_ASTC_12x12_SFLOAT_BLOCK_EXT, DXGI_FORMAT_ASTC_12X12_HDR, GL_COMPRESSED_RGBA_ASTC_12x12_KHR, GL_RGBA, 12, 12, 16, 4, FLAG_ENC_ASTC | FLAG_16F) // gl type same as LDR
...
MyMTLPixelFormat toggleSrgbFormat(MyMTLPixelFormat format)
{
    switch (format) {
        ...
        case MyMTLPixelFormatBC2_RGBA:
            return MyMTLPixelFormatBC2_RGBA_sRGB;
        case MyMTLPixelFormatBC2_RGBA_sRGB:
            return MyMTLPixelFormatBC2_RGBA;
